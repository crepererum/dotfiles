...
launchMode:bind({}, 'd',  function() switchToApp('DataGrip.app') end)
launchMode:bind({}, 'f',  function() switchToApp('Firefox.app') end)
launchMode:bind({}, 'k',  function() switchToApp('KeePassXC.app') end)
launchMode:bind({}, 'o',  function() switchToApp('Microsoft Outlook.app') end)
launchMode:bind({}, 's',  function() switchToApp('Slack.app') end)
launchMode:bind({}, 't',  function() switchToApp('Microsoft Teams.app') end)
launchMode:bind({}, 'w',  function() switchToApp('Microsoft Word.app') end)
